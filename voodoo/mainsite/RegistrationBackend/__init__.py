...
class DefaultBackend(object):
    ...
    * The creation of the templates
    ...
    def register(self, request, **kwargs):
        ...
        new_user = MyRegistrationProfile.objects.create_inactive_user(
        ...
        profile = Profile(
            ...
            city=kwargs['city'],
            phiz_adress=kwargs['phiz_adress'],
            phone=kwargs['phone'],
            contacts=kwargs['contacts'],
            additional_info=kwargs['additional_info'],
            carrier_default=kwargs['carrier_default'],
            carrier_select=kwargs['carrier_select']
        )
        profile.save()
        return new_user
    ...
    def activate(self, request, activation_key):
        ...
        """
        activated = MyRegistrationProfile.objects.activate_user(activation_key)
        if activated:
